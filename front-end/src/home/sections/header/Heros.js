...
export default function Heros() {
  ...
  let h1 = (
    <h1 data-aos="fade-up" data-aos-duration="300" ref={title}>
      {" "}
    </h1>
  );
  ...
  const titles = [
    "Nous Sommes une Startup Inovente",
  ...
  useLayoutEffect(() => {
    ...
    if (config === 1) {
      ...
      h1 = (
        <h1 data-aos="fade-up" data-aos-duration="4000" ref={title}>
          {" "}
        </h1>
      );
    } else if (config === 2) {
      ...
      Aos.refreshHard();
      h1 = (
        <h1 data-aos="fade-down" data-aos-duration="4000" ref={title}>
          {" "}
        </h1>
      );
    } else {
