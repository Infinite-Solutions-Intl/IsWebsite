    ...
    <div className='container-presentation'>
        <div className='presentation'  >
            ...
            <svg  width="438" height="524" viewBox="0 0 438 524" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M479 374.963C444.876 394.702 405.257 406 363 406C234.87 406 131 302.13 131 174C131 107.9 158.643 48.2571 202.999 6H119.262C86.3028 53.7274 67 111.609 67 174C67 337.476 199.524 470 363 470C404.171 470 443.378 461.595 479 446.406V374.963Z" fill="#1B3987"/>
                </g>
                <defs>
                ...
                <feColorMatrix type="matrix" values="0 0 0 0 0.105882 0 0 0 0 0.223529 0 0 0 0 0.529412 0 0 0 0.12 0"/>
